            ...
            <div className="container-main">
              ...
              <div className="container-item">
                <form>
                  ...
                  <div className="div-li">
                    <label className={"label-r"}>
                      Aadhaar Number <span style={{ color: "tomato" }}>*</span>
                      <input
                        className={"input-r"}
                        type="number"
                        placeholder="eg. 888800001111"
                  ...
                  <p className="note">
                    ...
                    <br /> Make sure your account address and Aadhaar Number are
                    correct. <br /> Admin might not approve your account if the
                    provided Aadhaar Number  does not match the account
                    address registered in admin's catalogue.
                  </p>
                  <button
                    className="btn-add"
                    disabled={
